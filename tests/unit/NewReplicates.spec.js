...
describe('Replicates.vue', () => {
  ...
  describe.only('Replicates', () => {
    ...
    it('each replicate will have correct stats', () => {
      const firstReplicate = replicates.find('A1')
    ...
    it.only('will add the replicate to the well', () => {
      console.log(well1.replicate.concentrations())
      console.log(replicate1.concentrations())

      console.log(well6.replicate.concentrations())
      console.log(replicate2.concentrations())
    ...
    it('can pass options to each replicate', () => {
      const replicate = replicates.find('A1')
